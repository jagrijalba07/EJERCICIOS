...
document.getElementById("BigInt__iniciarSecion").addEventListener("click",iniciarSecion);
document.getElementById("BigInt__registrase").addEventListener("click",register);
